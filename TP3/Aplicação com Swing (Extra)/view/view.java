...
public class view implements ActionListener {
    ...
    public ArrayList<JFrame> getPages(){
        return this.pages;
    }
    public void setPages(ArrayList<JFrame> pages){
        this.pages = pages;
    }

    public void setPressed(Object pressed){
    ...
    public view(){
        ...
        // ArrayList<JFrame> newPages = new ArrayList<>();
        // newPages.add(first_page);
        // newPages.add(register_page);
        // newPages.add(profile_page);
        // this.setPages(newPages);
        // this.getPages().get(0).setVisible(true);
    }
    ...
    public void actionPerformed(ActionEvent e){
        ...
        // Logar na página principal
            ...
            // Verifica se a senha de input está igual a senha cadastrada
                ...
                updatePage(first_page, profile_page);
            }
        }
